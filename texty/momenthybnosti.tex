...
Necháme-li působit operátor $\hat{L_{\pm}}$ na stav $\ket{lm}$ dostaneme
\begin{equation}
...
\begin{figure} [!ht]
\centering
\includegraphics[scale=1]{vektorovymodel.pdf}
...
\begin{figure} [!ht]
\centering
\includegraphics[scale=1]{zebrickoveoperatory.pdf}
